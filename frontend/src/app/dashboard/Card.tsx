  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`${styles.flipCardFront} bg-gray-800 rounded-2xl p-8 shadow-2xl border border-gray-500/50`}
        >
        ...
        {/* Back of card (Answer) */}
        <div
          className={`${styles.flipCardBack} bg-gray-800 rounded-2xl p-8 shadow-2xl border border-gray-500/50`}
        >
          <div className="space-y-6">
            <div className="flex items-center justify-center space-x-2 mb-6">
